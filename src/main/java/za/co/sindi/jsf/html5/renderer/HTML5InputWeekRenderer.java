...
import za.co.sindi.jsf.html5.component.input.HTML5InputWeek;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputWeek.RENDERER_TYPE)
public class HTML5InputWeekRenderer extends HTML5InputRenderer {
	
	private static final String[] INPUT_WEEK_ATTRIBUTES = {
