...
import za.co.sindi.jsf.html5.component.input.HTML5InputURL;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputURL.RENDERER_TYPE)
public class HTML5InputURLRenderer extends HTML5InputRenderer {
	
	private static final String[] INPUT_URL_ATTRIBUTES = {
