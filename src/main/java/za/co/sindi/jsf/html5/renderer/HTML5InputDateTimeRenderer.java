...
import za.co.sindi.jsf.html5.component.input.HTML5InputDateTime;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputDateTime.RENDERER_TYPE)
public class HTML5InputDateTimeRenderer extends HTML5InputRenderer {
