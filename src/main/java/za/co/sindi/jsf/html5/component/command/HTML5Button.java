...
public class HTML5Button extends HTML5UICommand implements HTML5UIButton {

	public static final String COMPONENT_TYPE = "za.co.sindi.jsf.html5.HTML5CommandButton";
