...
import za.co.sindi.jsf.html5.component.input.HTML5InputDate;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputDate.RENDERER_TYPE)
public class HTML5InputDateRenderer extends HTML5InputRenderer {
