...
import za.co.sindi.jsf.html5.component.input.HTML5InputDateTimeLocal;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputDateTimeLocal.RENDERER_TYPE)
public class HTML5InputDateTimeLocalRenderer extends HTML5InputRenderer {
	
	private static final String[] INPUT_DATE_ATTRIBUTES = {
