...
import za.co.sindi.jsf.html5.component.input.HTML5InputTime;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputTime.RENDERER_TYPE)
public class HTML5InputTimeRenderer extends HTML5InputRenderer {
	
	private static final String[] INPUT_TIME_ATTRIBUTES = {
