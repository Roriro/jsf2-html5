 ...
 * 
 */
package za.co.sindi.jsf.html5.component.outcome;
 ...
 *
 */
@FacesComponent(HTML5Button.COMPONENT_TYPE)
public class HTML5Button extends HTML5UIOutcomeTarget implements HTML5UIButton {

	public static final String COMPONENT_TYPE = "za.co.sindi.jsf.html5.HTML5OutcomeTargetButton";
	public static final String RENDERER_TYPE = "za.co.sindi.jsf.html5.Button";
