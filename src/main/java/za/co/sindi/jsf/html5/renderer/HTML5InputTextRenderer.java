...
import za.co.sindi.jsf.html5.component.input.HTML5InputText;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = HTML5InputText.RENDERER_TYPE)
public class HTML5InputTextRenderer extends HTML5InputRenderer {
	
	private static final String[] INPUT_TEXT_ATTRIBUTES = {
