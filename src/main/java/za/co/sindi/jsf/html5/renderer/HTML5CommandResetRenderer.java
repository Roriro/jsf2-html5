...
import za.co.sindi.jsf.html5.component.command.HTML5ButtonReset;
 ...
 *
 */
@FacesRenderer(componentFamily = "javax.faces.Command", rendererType = HTML5ButtonReset.RENDERER_TYPE)
public class HTML5CommandResetRenderer extends HTML5ButtonRenderer {
