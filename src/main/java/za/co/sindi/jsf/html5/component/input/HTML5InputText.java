 ...
 *
 */
@FacesComponent(HTML5InputText.COMPONENT_TYPE)
public class HTML5InputText extends HTML5UIInput {

	public static final String COMPONENT_TYPE = "za.co.sindi.jsf.html5.HTML5InputText";
	public static final String RENDERER_TYPE = "za.co.sindi.jsf.html5.InputText";
