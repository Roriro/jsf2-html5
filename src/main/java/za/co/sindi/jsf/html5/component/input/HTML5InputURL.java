 ...
 *
 */
@FacesComponent(HTML5InputURL.COMPONENT_TYPE)
public class HTML5InputURL extends HTML5UIInput {

	public static final String COMPONENT_TYPE = "za.co.sindi.jsf.html5.HTML5InputURL";
	public static final String RENDERER_TYPE = "za.co.sindi.jsf.html5.InputURL";
	 ...
	 * 
	 */
	public HTML5InputURL() {
		super();
		// TODO Auto-generated constructor stub
		setRendererType(RENDERER_TYPE);
//		setConverter(new URLConverter());
	}
